...
public class GamePad {
	 private Joystick m_Pad;   //Joystick object
	    ...
	    public double getLeftY() {
	        double answer = m_Pad.getRawAxis(1); //Return the left Y axis value
	    ...
	    public double getLeftX() {
	        return m_Pad.getRawAxis(0); //Return the left X axis value
	    }
	    ...
	    public double getRightY() {
	        return m_Pad.getRawAxis(3); //Return the right Y axis value
	    }
	    ...
	    public double getRightX() {
	        return m_Pad.getRawAxis(2); //Return the right X axis value
	    }
